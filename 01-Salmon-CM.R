...
saveRDS(samp, file = "CM/Salmon_10.22.25.rds")

samp <- readRDS(file = "CM/Salmon_10.22.25.rds")
...
salmonMSE::report_CM(
  samp,
  rs_names = rs_names, name = "Salmon", year = unique(full_table$BROOD_YEAR),
  dir = "CM", filename = "Salmon_22.14"
)
