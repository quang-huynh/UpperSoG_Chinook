...
The population phenotype that is altered by genetic introgression of hatchery spawners is modeled as a Gaussian random variable `z`, with an optimum at 100 in the natural environment and 80 in the hatchery environment. The variance of the phenotype is 10. 
...
The fitness variance is 100. Heritability $h^2$ is stochastic, sampled from a truncated normal distribution with mean of 0.25, standard deviation of 0.15, with bounds of 0 and 0.5.
...
csasdown::csas_table(
  sarita_table_bio,
  caption = "Biology, habitat, and harvest parameters."
) %>%
...
csasdown::csas_table(
  sarita_table_hatch,
  caption = "Hatchery and fitness parameters."
) %>%
  kableExtra::column_spec(c(1, 2), width = "3in")
```
