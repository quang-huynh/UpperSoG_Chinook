...
d <- list(
  ...
  cwtExp = 10 # Sarita used 1 #Walters and Korman (2024) used 0.1
)
...
saveRDS(samp, file = "CM/Quinsam_11.03.25.rds")

samp <- readRDS(file = "CM/Quinsam_11.03.25.rds")
